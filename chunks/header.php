...
<head>
    <meta charset="utf-8">
    <title>Calengramm</title>
    <meta name="description" content="Calengramm" />
    ...
    <link rel="stylesheet" href="/_assets/css/style.css?v=<?= $version ?>">

    <script src="/_assets/module/jquery/jquery-3.4.1.min.js"></script>
